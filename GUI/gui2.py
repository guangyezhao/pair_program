...
class history_window():
    ...
    def __init__(self):
        ...
        list = Listbox(self.root, yscrollcommand=scroll.set)
        for i in range(1000):
            lb.insert(END, i)
        ...
        for j in range(his_len):
            line = Label(self.root, text="time: "+his[4*j], height=2, width=25, font=("Arial", 20))
            line.grid(row=4*j)
            line = Label(self.root, text="total number: " + his[4*j+1], height=2, width=25, font=("Arial", 20))
            line.grid(row=4 * j+1)
            line = Label(self.root, text="right answer number: " + his[4*j+2], height=2, width=25, font=("Arial", 20))
            line.grid(row=4 * j+2)
            line = Label(self.root, text="正确率: " + his[4*j+3], height=2, width=25, font=("Arial", 20))
            line.grid(row=4 * j+3)
